...
export default function Input({ handleListData, setLoading }) {
  ...
  const handleSendFile = async () => {
    ...
    await axios
      .post('http://103.74.122.136:7100/api/ocr', formData)
  ...
  return (
    <div className='container-fluid input-style'>
      ...
      {/* <div className='btn-group' role='group'>
        <button type='button' className='btn disabled scenario'>
          Scenario
        </button>
        <Select
      ...
      <div className='btn-group ocr-button--border' role='group'>
        <button type='button' className='btn disabled scenario'>
          Input
        </button>
        <input
          ...
          placeholder='Enter ans URL or Upload file...'
        />
        <input
          type='file'
          name=''
